...
export const interceptResponse = async (page: Page, mockServerKey: MockServerKey, mockConfigKey: MockConfigKey, mockPayloadKey: MockPayloadKey,
    ...
    if (!mockServerPayload) {
        throw Error(`Не удалось найти файл полезной нагрузки ${mockPayloadKey} в формате JSON.`)
    }

    console.log(`${mockServerHostURL}${mockServerRoute}`)
